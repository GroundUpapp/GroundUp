const QUICK_ACTIONS = [
  { id: 'invoice', label: 'New Invoice', primary: true },
  { id: 'expense', label: 'Log Expense', primary: false },
  { id: 'job', label: 'Add Job', primary: false },
];
        ...
        <div className="flex flex-col gap-2">
          {QUICK_ACTIONS.map((a) => (
            <button
              ...
              className={
                a.primary
                  ? 'rounded-xl bg-amber-500 px-3 py-2 text-sm font-semibold text-ground-950 transition hover:bg-amber-400 active:scale-[0.98]'
                  : 'rounded-xl border border-amber-900/40 px-3 py-2 text-sm font-medium text-cream-200 transition hover:border-amber-500 hover:text-amber-300'
              }
            >
              {a.label}
            </button>
